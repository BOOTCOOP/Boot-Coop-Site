    ...
    configUser :function(options){
        ...
        if(settings.selector != ''){
            ...
            settings.users.forEach(function (user, index){
                ...
                userList +='<li style="justify-content: center" class="item rs-go-to-whatsapp '+active+'" data-userId="'+index+'">'+
                    ...
                    '<div class="list-latest-text"></div></div><div class="col col-1"><div class="list-icon-wrapper text-right" style="margin:20px">'+
            ...
            if(element !=null){
                var chatBox = '<div class="ayoan_whatsapp_chatbox_container">' +
                    ...
                    '<img class="icon custom-close-icon" src="assets/plugins/whatsApp/img/close.svg"></button></div></div>' +
